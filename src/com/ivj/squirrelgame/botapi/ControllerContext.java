...
public interface ControllerContext {
	 ...
	 * 
	 * @param direction
	 *            : one of XY.UP, XY.DOWN, ... XY.ZERO_ZERO means I want to
	 *            pause
	 */
	...
	/**
	 * Very destructive event (see specification for details). Can only be
	 * called for mini bot, otherwise exception.
	 * 
	 * @param impactRadius
